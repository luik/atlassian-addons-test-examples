package ut.com.milkneko.dev.jira_5_workflow_condition.workflow;

import com.milkneko.dev.jira_5_workflow_condition.workflow.MyWorkflowCondition;
...
public class MyWorkflowConditionTest
{
    public static final String FIELD_WORD = "word";

    protected MyWorkflowCondition condition;
    protected MutableIssue issue;

    @Before
    public void setup() {
        issue = mock(MutableIssue.class);
        condition = new MyWorkflowCondition() {
    ...
    public void testPassesCondition() throws Exception
    {
        ...
        boolean result = condition.passesCondition(null, args, null);
